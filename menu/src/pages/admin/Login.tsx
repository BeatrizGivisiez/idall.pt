  ...
  function validate() {
    ...
    if (!isLogin) {
      if (!restaurantName.trim())
        errs.restaurantName = "Informe o nome do negócio.";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (isLogin) {
        ...
        setSuccessMsg(
          `Seu cardápio em orderyhq.app/${slug || "seu-negocio"} está pronto. Vamos configurar o painel.`,
        );
        setSuccess(true);
            ...
            {!success ? (
              <div className="auth-form-inner">
                ...
                <form onSubmit={handleSubmit} noValidate>
                  ...
                  {/* Nome do negóciosó cadastro */}
                  <div
                    className={`auth-field signup-only${!isLogin ? " open" : ""}`}
                  >
                    ...
                    {errors.restaurantName && (
                      <div className="field-err">{errors.restaurantName}</div>
                    )}
                  </div>
                  ...
                  >
                    ...
                    {errors.slug && (
                      <div className="field-err">{errors.slug}</div>
                    )}
                  </div>
                  ...
                  {isLogin && (
                    <div className="auth-meta">
                      <label className="remember">
                        <input type="checkbox" defaultChecked /> Manter
                        conectado
                      </label>
